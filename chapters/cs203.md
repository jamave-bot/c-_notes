...
<img src="./images/fig_19_4.png" alt="template class">

- We make ```List<NODETYPE>``` a friend class so they have direct access to our datamembers without a function call


<hr> 

## Search/Sorting references

<img src="./images/fig_20_1.png" alt="reference pages in textbook"> 