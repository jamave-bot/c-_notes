...
template<typename NODETYPE> class CircularDoublyLinkedList;                            

template<typename NODETYPE>
class ListNode {
   friend class CircularDoublyLinkedList<NODETYPE>; // make CircularDoublyLinkedList a friend so it has access to methods in this class

public:
   explicit ListNode(const NODETYPE& info) // constructor
      : data{info}, nextPtr{nullptr}, prevPtr{nullptr} {}
